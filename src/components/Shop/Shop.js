...
const Shop = () => {
    ...
    document.title = "Shop"
    useEffect(()=>{
      fetch('https://shrouded-oasis-10859.herokuapp.com/products?search='+search)
      .then(res => res.json())
    ...
    return (
        <div className="twin-container">
          <div className="product-container">
            <input onBlur={handleSearch} type="text" className="productSearch" placeholder="Search Product"/>
            {
